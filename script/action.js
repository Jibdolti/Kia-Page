$(document).ready(function() {
    ...
    $('#section3 .contetn .name').each(function(){
       let name = $(this).text(); //황희찬
    ...
    //     if(scrollTop >= section1Top - winH/4){
    ...
    //     if(scrollTop >= section2Top - winH/4){
    //         $('.floating_menu a').removeClass('on');
    //         $('.floating_menu a[href="#section2"]').addClass('on');
    //     }
        
    //     if(scrollTop >= section3Top - winH/4){
    //         $('.floating_menu a').removeClass('on');
